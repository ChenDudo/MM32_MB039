...
static s16_t snmpengine_scalars_get_value(const struct snmp_scalar_array_node_def* node, void* value)
{
    ...
    switch (node->oid) {
        case 1: /* snmpEngineID */
            ...
            return engineid_len;
        case 2: /* snmpEngineBoots */ *(s32_t*)value = snmpv3_get_engine_boots_internal(); return sizeof(s32_t);
        case 3: /* snmpEngineTime */ *(s32_t*)value = snmpv3_get_engine_time_internal(); return sizeof(s32_t);
        case 4: /* snmpEngineMaxMessageSize */ *(s32_t*)value = SNMP_FRAMEWORKMIB_SNMPENGINEMAXMESSAGESIZE; return sizeof(s32_t);
...
const struct snmp_mib                snmpframeworkmib = {snmpframeworkmib_base_oid, LWIP_ARRAYSIZE(snmpframeworkmib_base_oid),
