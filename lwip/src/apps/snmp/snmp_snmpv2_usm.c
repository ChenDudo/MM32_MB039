...
static const struct snmp_oid_range usmUserTable_oid_ranges[] = {
    {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff},
    {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff},
    {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}, {0, 0xff}};
...
static snmp_err_t
usmusertable_get_instance(const u32_t* column, const u32_t* row_oid, u8_t row_oid_len, struct snmp_node_instance* cell_instance)
{
    const char* engineid;
    u8_t        eid_len;
 ...
 */
static snmp_err_t
usmusertable_get_next_instance(const u32_t* column, struct snmp_obj_id* row_oid, struct snmp_node_instance* cell_instance)
{
    const char* engineid;
    u8_t        eid_len;
...
static s16_t usmusertable_get_value(struct snmp_node_instance* cell_instance, void* value)
{
    ...
    switch (SNMP_TABLE_GET_COLUMN_FROM_OID(cell_instance->instance_oid.id)) {
        ...
        case 6: /* usmUserAuthKeyChange */ return 0;
        case 7: /* usmUserOwnAuthKeyChange */ return 0;
        ...
        case 9: /* usmUserPrivKeyChange */ return 0;
        case 10: /* usmUserOwnPrivKeyChange */ return 0;
...
static s16_t usmstats_scalars_get_value(const struct snmp_scalar_array_node_def* node, void* value)
{
    ...
    switch (node->oid) {
        case 1: /* usmStatsUnsupportedSecLevels */ *uint_ptr = snmp_stats.unsupportedseclevels; break;
        case 2: /* usmStatsNotInTimeWindows */ *uint_ptr = snmp_stats.notintimewindows; break;
        case 3: /* usmStatsUnknownUserNames */ *uint_ptr = snmp_stats.unknownusernames; break;
        case 4: /* usmStatsUnknownEngineIDs */ *uint_ptr = snmp_stats.unknownengineids; break;
        case 5: /* usmStatsWrongDigests */ *uint_ptr = snmp_stats.wrongdigests; break;
        case 6: /* usmStatsDecryptionErrors */ *uint_ptr = snmp_stats.decryptionerrors; break;
        default: LWIP_DEBUGF(SNMP_MIB_DEBUG, ("usmstats_scalars_get_value(): unknown id: %" S32_F "\n", node->oid)); return 0;
    }
...
static const struct snmp_table_node usmusertable = SNMP_TABLE_CREATE(2,
