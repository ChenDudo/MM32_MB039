...
#define SD_POLLING_MODE                                                                                                          \
    0  /// Query mode. In this mode, it is recommended to increase the setting of SDIO_TRANSFER_CLK_DIV if there are problems with
       /// reading and writing.
#define SD_DMA_MODE                                                                                                              \
    1  /// In DMA mode, it is recommended to increase the setting of SDIO_TRANSFER_CLK_DIV if there are problems with reading and
       /// writing.
...
typedef enum {
    ...
    SD_BLOCK_LEN_ERR,  ///< Transferred block length is not allowed for the card or the number of transferred bytes does not match
                       ///< the block length
    ...
    SD_LOCK_UNLOCK_FAILED,     ///< Sequence or password error has been detected in unlock command or if there was an attempt to
