...
#define ETH_DMA_TDES_ES                                                                                                          \
    ((uint32_t)0x00008000)  ///< Error summary: OR of the following bits: UE || ED || EC || LCO || NC || LCA || FF || JT
...
#define ETH_DMA_RDES_MAMPCE                                                                                                      \
    ((uint32_t)0x00000001)  ///< Rx MAC Address/Payload Checksum Error: Rx MAC address matched/ Rx Payload Checksum Error
...
#define ETH_DMA_PTP_RDES_PTPMT_PdelayReq_Announce                                                                                \
    ((uint32_t)0x00000500)  ///< PdelayReq message (peer-to-peer transparent clock) or Announce message (Ordinary or Boundary
                            ///< clock)
#define ETH_DMA_PTP_RDES_PTPMT_PdelayResp_Manag                                                                                  \
    ((uint32_t)0x00000600)  ///< PdelayResp message (peer-to-peer transparent clock) or Management message (Ordinary or Boundary
                            ///< clock)
#define ETH_DMA_PTP_RDES_PTPMT_PdelayRespFollowUp_Signal                                                                         \
    ((uint32_t)0x00000700)  ///< PdelayRespFollowUp message (peer-to-peer transparent clock) or Signaling message (Ordinary or
                            ///< Boundary clock)
...
#define ETH_DMA_TDES_ChecksumTCPUDPICMPSegment                                                                                   \
    ((uint32_t)0x00800000)  ///< TCP/UDP/ICMP checksum insertion. Pseudo header checksum is assumed to be present
#define ETH_DMA_TDES_ChecksumTCPUDPICMPFull                                                                                      \
    ((uint32_t)0x00C00000)  ///< TCP/UDP/ICMP checksum fully in hardware including pseudo header
