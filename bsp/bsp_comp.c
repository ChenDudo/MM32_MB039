...
void BSP_COMP_GPIO_Configure(u32 COMPx, u8 inp, u8 inm, u8 out)
{
    ...
    switch ((u32)COMPx) {
        case COMP1:
            ...
            if (out == 1) {
                GPIOA->CRH  = GPIOA->CRH & ~(0x0F << ((14 % 8) * 4));
                GPIOA->AFRH = GPIOA->AFRH & ~(0x0F << ((14 % 8) * 4)) | (0x07 << ((14 % 8) * 4));
            }
            if (out == 2) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((4 % 8) * 4));
            ...
            if (inp == 1) {
                ...
                GPIOA->CRL  = GPIOA->CRL & ~(0x0F << ((1 % 8) * 4));
                GPIOA->AFRL = GPIOA->AFRL & ~(0x0F << ((1 % 8) * 4)) | (0x07 << ((1 % 8) * 4));
            }
            else if (inp == 3) {
                GPIOA->CRH  = GPIOA->CRH & ~(0x0F << ((2 % 8) * 4));
                GPIOA->AFRH = GPIOA->AFRH & ~(0x0F << ((2 % 8) * 4)) | (0x07 << ((2 % 8) * 4));
            }
            else if (inp == 4) {
                GPIOA->CRH  = GPIOA->CRH & ~(0x0F << ((3 % 8) * 4));
            ...
            if (inm == 1) {
                ...
                GPIOA->CRH  = GPIOA->CRH & ~(0x0F << ((0 % 8) * 4));
        ...
        case COMP2:
            ...
            if (inm == 4) {
                ...
                GPIOA->CRL  = GPIOA->CRL & ~(0x0F << ((2 % 8) * 4));
            ...
            if (out == 0) {
                ...
                GPIOA->CRL  = GPIOA->CRL & ~(0x0F << ((7 % 8) * 4));
        ...
        case COMP2:
            ...
            if (out == 1) {
                GPIOA->CRH  = GPIOA->CRH & ~(0x0F << ((13 % 8) * 4));
                GPIOA->AFRH = GPIOA->AFRH & ~(0x0F << ((13 % 8) * 4)) | (0x07 << ((13 % 8) * 4));
            }
            if (out == 2) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((0 % 8) * 4));
                GPIOD->AFRL = GPIOD->AFRL & ~(0x0F << ((0 % 8) * 4)) | (0x07 << ((0 % 8) * 4));
            }
            if (out == 3) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((5 % 8) * 4));
        ...
        case COMP3:
            ...
            if (out == 1) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((1 % 8) * 4));
                GPIOD->AFRL = GPIOD->AFRL & ~(0x0F << ((1 % 8) * 4)) | (0x07 << ((1 % 8) * 4));
            }
            if (out == 2) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((6 % 8) * 4));
        ...
        case COMP4:
            if (inp == 0) {
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((3 % 8) * 4));
                ...
                GPIOB->CRL  = GPIOB->CRL & ~(0x0F << ((2 % 8) * 4));
                ...
                GPIOD->CRL  = GPIOD->CRL & ~(0x0F << ((2 % 8) * 4));
    ...
    switch (COMPx) {
        case COMP1:
#if defined(__MM0N1)
            if (inm == 4)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_4, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (inm == 5)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_5, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (inm == 6)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_0, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (inm == 7)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);

            GPIO_Mode_IN_Init(GPIOA, 1 << inp, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (out == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_0, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 2)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 3)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_11, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;
#endif
#if defined(__MM0P1)
            ...
            if (out == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_14, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 2)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_4, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;
#endif
#if defined(__MM0Q1)
            if (inm == 0)
            ...
            if (inm == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (inm == 2)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_7, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            ...
            if (inp == 0)
                ...
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_1, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 2)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_2, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 3)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_3, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
        ...
        case COMP2:
            ...
            GPIO_Mode_IN_Init(GPIOA, 1 << inp, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            if (out == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_2, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 2)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_7, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 3)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_12, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;
#endif
#if defined(__MM0S1)
        case COMP2:
            ...
            if (out == 1)
                ...
                GPIO_Mode_IN_Init(GPIOC, GPIO_Pin_10, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;
#endif
#if defined(__MM0P1)
        case COMP2:
            ...
            if (out == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_13, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 2)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_0, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 3)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_5, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;
#endif
        ...
        case COMP3:
            ...
            if (out == 1)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_1, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            else if (out == 2)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_7);
            break;

        case COMP4:
            if (inp == 0)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_3, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 2)
                GPIO_Mode_IN_Init(GPIOB, GPIO_Pin_2, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 3)
                GPIO_Mode_IN_Init(GPIOB, GPIO_Pin_10, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);

            if (inm == 0)
                GPIO_Mode_IN_Init(GPIOB, GPIO_Pin_12, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inm == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_8, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inm == 2)
                GPIO_Mode_IN_Init(GPIOD, GPIO_Pin_2, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
        ...
        case COMP5:
            if (inp == 0)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_11, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 1)
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_6, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            else if (inp == 2)
                GPIO_Mode_IN_Init(GPIOB, GPIO_Pin_2, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
            ...
            if (inm == 0)
                ...
                GPIO_Mode_IN_Init(GPIOA, GPIO_Pin_12, GPIO_Mode_AIN, NO_REMAP, GPIO_AF_0);
