...
#define UART1_TX_CONFIGURE                                                                                                       \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(UART1_TX_PORT, UART1_TX_PIN, NO_REMAP, UART1_TX_AF);                                          \
    }
#define UART1_RX_CONFIGURE                                                                                                       \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(UART1_RX_PORT, UART1_RX_PIN, NO_REMAP, UART1_RX_AF);                                                  \
    }

#define UART2_TX_CONFIGURE                                                                                                       \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(UART2_TX_PORT, UART2_TX_PIN, NO_REMAP, UART2_TX_AF);                                          \
    }
#define UART2_RX_CONFIGURE                                                                                                       \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(UART2_RX_PORT, UART2_RX_PIN, NO_REMAP, UART2_RX_AF);                                                  \
    }
