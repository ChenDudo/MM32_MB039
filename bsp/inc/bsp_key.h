...
typedef enum { KEY_RELEASE, KEY_DOWN, KEY_DOWNED, KEY_PRESSING, KEY_PRESSED, KEY_DBCLICK } KEY_STATUS;
...
#define KEY2_CONFIG                                                                                                              \
    {                                                                                                                            \
        ...
        GPIO_Mode_IPD_Init(KEY2_PORT, KEY2_BIT, NO_REMAP, GPIO_AF_0);                                                            \
    }
#define KEY3_CONFIG                                                                                                              \
    {                                                                                                                            \
...
#define KEY1_CONFIG                                                                                                              \
    {                                                                                                                            \
        ...
        GPIO_Mode_IPU_Init(KEY1_PORT, KEY1_BIT, NO_REMAP, GPIO_AF_0);                                                            \
    }
#define KEY2_CONFIG                                                                                                              \
    {                                                                                                                            \
...
#define KEY1_CONFIG                                                                                                              \
    {                                                                                                                            \
        COMMON_EnableIpClock(emCLOCK_GPIOB);                                                                                     \
        GPIO_Mode_IPD_Init(KEY1_PORT, KEY1_BIT, NO_REMAP, GPIO_AF_15);                                                           \
    }
#define KEY2_CONFIG                                                                                                              \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(KEY2_PORT, KEY2_BIT, NO_REMAP, GPIO_AF_15);                                                           \
    }
#define KEY3_CONFIG                                                                                                              \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(KEY3_PORT, KEY3_BIT, NO_REMAP, GPIO_AF_15);                                                           \
    }
#define KEY4_CONFIG                                                                                                              \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(KEY4_PORT, KEY4_BIT, NO_REMAP, GPIO_AF_15);                                                           \
    }
