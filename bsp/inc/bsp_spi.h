...
#define SPI1_MASTER_SCK_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI1_SCK_PORT, SPI1_SCK_BIT, NO_REMAP, SPI1_SCK_AF);                                          \
    }
#define SPI1_MASTER_MISO_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI1_MISO_PORT, SPI1_MISO_BIT, NO_REMAP, SPI1_MISO_AF);                                               \
    }
#define SPI1_MASTER_MOSI_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI1_MOSI_PORT, SPI1_MOSI_BIT, NO_REMAP, SPI1_MOSI_AF);                                       \
    }
#define SPI1_MASTER_NSS_CONFIG()                                                                                                 \
    {                                                                                                                            \
        exGPIO_PinAFConfig(SPI1_NSS_PORT, SPI1_NSS_BIT, NO_REMAP, SPI1_NSS_AF);                                                  \
    }
#define SPI1_MASTER_NSS_SW_CTL(x)                                                                                                \
    {                                                                                                                            \
        if (x)                                                                                                                   \
            GPIO_Mode_AF_PP_50MHz_Init(SPI1_NSS_PORT, SPI1_NSS_BIT, NO_REMAP, SPI1_NSS_AF);                                      \
        else {                                                                                                                   \
...
#define SPI1_SLAVER_SCK_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_FLOATING_Init(SPI1_SCK_PORT, SPI1_SCK_BIT, NO_REMAP, SPI1_SCK_AF);                                             \
    }
#define SPI1_SLAVER_MISO_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI1_MISO_PORT, SPI1_MISO_BIT, NO_REMAP, SPI1_MISO_AF);                                       \
    }
#define SPI1_SLAVER_MOSI_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI1_MOSI_PORT, SPI1_MOSI_BIT, NO_REMAP, SPI1_MOSI_AF);                                               \
    }
#define SPI1_SLAVER_NSS_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI1_NSS_PORT, SPI1_NSS_BIT, NO_REMAP, SPI1_NSS_AF);                                                  \
    }
...
#endif
#endif
#define SPI2_MASTER_SCK_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI2_SCK_PORT, SPI2_SCK_BIT, NO_REMAP, SPI2_SCK_AF);                                          \
    }
#define SPI2_MASTER_MISO_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI2_MISO_PORT, SPI2_MISO_BIT, NO_REMAP, SPI2_MISO_AF);                                               \
    }
#define SPI2_MASTER_MOSI_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI2_MOSI_PORT, SPI2_MOSI_BIT, NO_REMAP, SPI2_MOSI_AF);                                       \
    }
#define SPI2_MASTER_NSS_CONFIG()                                                                                                 \
    {                                                                                                                            \
        exGPIO_PinAFConfig(SPI2_NSS_PORT, SPI2_NSS_BIT, NO_REMAP, SPI2_NSS_AF);                                                  \
    }
#define SPI2_MASTER_NSS_SW_CTL(x)                                                                                                \
    {                                                                                                                            \
        if (x)                                                                                                                   \
            GPIO_Mode_AF_PP_50MHz_Init(SPI2_NSS_PORT, SPI2_NSS_BIT, NO_REMAP, SPI2_NSS_AF);                                      \
        else {                                                                                                                   \
...
#define SPI2_SLAVER_SCK_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_FLOATING_Init(SPI2_SCK_PORT, SPI2_SCK_BIT, NO_REMAP, SPI2_SCK_AF);                                             \
    }
#define SPI2_SLAVER_MISO_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_AF_PP_50MHz_Init(SPI2_MISO_PORT, SPI2_MISO_BIT, NO_REMAP, SPI2_MISO_AF);                                       \
    }
#define SPI2_SLAVER_MOSI_CONFIG()                                                                                                \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI2_MOSI_PORT, SPI2_MOSI_BIT, NO_REMAP, SPI2_MOSI_AF);                                               \
    }
#define SPI2_SLAVER_NSS_CONFIG()                                                                                                 \
    {                                                                                                                            \
        GPIO_Mode_IPU_Init(SPI2_NSS_PORT, SPI2_NSS_BIT, NO_REMAP, SPI2_NSS_AF);                                                  \
    }
