...
#define LED2_CONFIG                                                                                                              \
    {                                                                                                                            \
        ...
        GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, GPIO_AF_0);                                                   \
    }
...
#define LED5_CONFIG                                                                                                              \
    {                                                                                                                            \
        ...
        GPIO_Mode_OUT_OD_20MHz_Init(LED5_PORT, LED5_BIT, AFIO_MAPR_SWJ_JTAGDISABLE, GPIO_AF_0);                                  \
    }
#define LED6_CONFIG                                                                                                              \
    {                                                                                                                            \
        COMMON_EnableIpClock(emCLOCK_GPIOA);                                                                                     \
        GPIO_SetBits(LED6_PORT, LED6_BIT);                                                                                       \
        GPIO_Mode_OUT_OD_20MHz_Init(LED6_PORT, LED6_BIT, NO_REMAP, GPIO_AF_0);                                                   \
    }
...
#if defined(__MM32_MB022) || defined(__MM32_MB023) || defined(__MM32_MB024) || defined(__MM32_MB025) || defined(__MM32_MB036) || \
    defined(__MM32_MB039)
...
#define LED2_CONFIG                                                                                                              \
    {                                                                                                                            \
        COMMON_EnableIpClock(emCLOCK_GPIOB);                                                                                     \
        GPIO_SetBits(LED2_PORT, LED2_BIT);                                                                                       \
        GPIO_Mode_OUT_OD_20MHz_Init(LED2_PORT, LED2_BIT, NO_REMAP, 0xF);                                                         \
    }
#else
#define LED2_CONFIG                                                                                                              \
    {                                                                                                                            \
