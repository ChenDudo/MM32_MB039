...
#if defined(SPI1)
void BSP_SPI1_NSS_ENABLE(void)
{
    GPIO_ResetBits(SPI1_NSS_PORT, SPI1_NSS_BIT);
    nssStatus = true;
}
void BSP_SPI1_NSS_DISABLE(void)
{
...
#if defined(SPI2)
void BSP_SPI2_NSS_ENABLE(void)
{
    GPIO_ResetBits(SPI2_NSS_PORT, SPI2_NSS_BIT);
    nssStatus = true;
}
void BSP_SPI2_NSS_DISABLE(void)
{
...
#if defined(SPI1)
    if (SPIx == SPI1)
        (newState) ? BSP_SPI1_NSS_ENABLE() : BSP_SPI1_NSS_DISABLE();
#endif
#if defined(SPI2)
    if (SPIx == SPI2)
        (newState) ? BSP_SPI2_NSS_ENABLE() : BSP_SPI2_NSS_DISABLE();
#endif
}
